...
while($category = mysqli_fetch_array($categories)){
	...
	?>
	<section class="home-slider js-fullheight owl-carousel" style="background-image:url(images/categories/<?php echo $category['image']?>);background-attachment: fixed;background-size: cover;background-repeat: no-repeat;background-position: center center;">
			...
			<div class="container">
				<div class="row no-gutters slider-text js-fullheight align-items-center justify-content-end" data-scrollax-parent="true">
					<div class="col-md-7 text ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
						...
						<p data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Fugiat cum ducimus maxime debitis quis. Nobis?</p>
						<?php
						$subcategories = $subcatObj->getSubcatByCatId($category['id']);
						if($subcategories){
							?>
							<p><button type="button" class="btn btn-white btn-outline-white px-4 py-3 mt-3" data-toggle="modal" data-target="#category-1">View <?php echo $category['categories']?></button></p>
							<?php
						}
						else{
							?>
							<p><a href="category.php?catid=<?php echo $category['id']?>" class="btn btn-white btn-outline-white px-4 py-3 mt-3">View <?php echo $category['categories']?></a></p>
							<?php
						}
						?>
					</div>
...
<!-- Modal -->
<div class="modal category-modal fade" id="category-1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title text-center w-100 text-light" id="exampleModalLabel">Board Games</h5>
		...
		<div class="container-wrap">
			<div class="row no-gutters">
				<div class="col-md-6 col-lg-6 ftco-animate">
					<div class="project">
						<img src="images/sub-categories/bg_1.jpg" class="img-fluid" alt="Colorlib Template">
						<div class="text">
							<h3>Office Interior Design in Paris</h3>
						</div>
						<a href="categories.php?catid=1&subcatid=1" class="icon d-flex justify-content-center align-items-center">
				...
				<div class="col-md-6 col-lg-6 ftco-animate">
					<div class="project">
						<img src="images/sub-categories/bg_2.jpg" class="img-fluid" alt="Colorlib Template">
						<div class="text">
							<h3>Office Interior Design in Paris</h3>
						</div>
						<a href="categories.php?catid=1&subcatid=1" class="icon d-flex justify-content-center align-items-center">
