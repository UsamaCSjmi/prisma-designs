                        ...
                        <table class="table ">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><img src="<?php echo IMAGE_SITE_PATH."sub-categories/".$row['image']?>" alt=""></td>
                                    <td>
                                    <?php
                                    if($row['status']==1){
                                    ...
                                    echo "<span class='badge badge-edit'><a href='manage_sub_categories.php?id=".$row['id']."' >Edit</a></span>&nbsp";
